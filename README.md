...
- Notes and mini-projects from my ongoing Python learning journey  
- Coursework and exercises from online programs (e.g. *Python for Everybody*, *Deep Learning for NLP*)  
- Occasional reflections or experiments that remind me why I started coding in the first place  

---

### ☕️ Final Note

This repo is both my personal record and a small portfolio for professors or reviewers  
who might want to see how I learn, build, and (sometimes) break things on purpose.  
